 ...
 * @property {?MarkdownServer~resolverOptions} resolverOptions Gets or sets optional global options used by the resolver to configure default page name and file extension of Markdown files.
 *
 * @example
 * var path = require('path'),
 *     mds = require('markdown-serve');
 ...
 * @param {MarkdownServer~getCallback} callback
 ...
 * @param {MarkdownServer~saveCallback} callback
 * @returns {MarkdownFile}
 *
 * @example
